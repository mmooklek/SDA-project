...
svm_model, svm_predictions = functions.svm_regression(train, test, Y_NAME, X_NAME)
...
svm_mse = mean_squared_error(test[Y_NAME], svm_predictions)
...
rsq_svm = functions.calculate_r_squared(test[Y_NAME], svm_predictions)
...
model_evaluation = pd.DataFrame({
    'Model': ['Hedonic Pricing model', 'Lasso model', 'Ridge model', 'Decision Tree model', 
              'Random Forest model', 'XGBoost model', 'SVM model', 'Neural Network model'],
    'Out_of_sample_MSE': [hedonic_mse, lasso_mse, ridge_mse, tree_mse, rf_mse, xgb_mse, svm_mse, nn_mse],
    'R_squared': [rsq_hedonic, rsq_lasso, rsq_ridge, rsq_tree, rsq_rf, rsq_xgb, rsq_svm, rsq_nn]
})
...
### 7.) Support Vector Machine (SVM)
svm_model_czh, svm_predictions_czh = functions.svm_regression(train_czh, test_czh, Y_NAME_czh, X_NAME_czh)
...
svm_mse_czh = mean_squared_error(test_czh[Y_NAME_czh], svm_predictions_czh)
...
rsq_svm_czh = functions.calculate_r_squared(test_czh[Y_NAME_czh], svm_predictions_czh)
...
model_evaluation_czh = pd.DataFrame({
    'Model': ['Hedonic Pricing model', 'Lasso model', 'Ridge model', 'Decision Tree model', 
              'Random Forest model', 'XGBoost model', 'SVM model', 'Neural Network model'],
    'Out_of_sample_MSE': [hedonic_mse_czh, lasso_mse_czh, ridge_mse_czh, tree_mse_czh, rf_mse_czh, xgb_mse_czh, svm_mse_czh, nn_mse_czh],
    'R_squared': [rsq_hedonic_czh, rsq_lasso_czh, rsq_ridge_czh, rsq_tree_czh, rsq_rf_czh, rsq_xgb_czh, rsq_svm_czh, rsq_nn_czh]
})
